...
import styles from '../formularioQuestoes/FormularioQuestoes.module.css'
...
export default function FormularioQuestoes() {
    ...
    return (
        <Layout>
            <Heading as='h3' size='lg' className={styles.titulo}>Formulário Personalizado</Heading>
            <p className={styles.texto}>Aqui você pode personalizar as questões do hemocentro que deverão ser respondidas pelo doador na triagem no aplicativo</p>
            <div>
                {isLoading && (
            ...
            >
                <ModalOverlay />
                <ModalContent>
                    <ModalHeader className={styles.modal_header}><h1 className={styles.modal_header_text}>Adicionar Nova Questão</h1></ModalHeader>
                    ...
                    <ModalFooter className={styles.modal_footer}>
                        ...
                        <button onClick={handleSaveModalClose} className={styles.secondary_button}>Cancelar</button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
            <Modal
            ...
            >
                <ModalOverlay />
                <ModalContent>
                    <ModalHeader className={styles.modal_header}><h1 className={styles.modal_header_text}>Editar Questão</h1></ModalHeader>
                    ...
                    <ModalFooter>
                        <div className={styles.modal_footer}>
                            <button className={styles.primary_button} onClick={handleUpdate}>
                                Salvar
                            </button>
    ...
    return (
        <div>
            ...
            >
                <ModalOverlay />
                <ModalContent>
                    <ModalHeader className={styles.modal_header}><h1 className={styles.modal_header_text}>Adicionar nova opção</h1></ModalHeader>
                    <ModalCloseButton onClick={handleClose} />
                    <ModalBody className={styles.modal_body}>
                        <FormControl isInvalid={!!error}>
